...
//         //web audio api creation setup
//     audioContext= new(window.AudioContext || window.webkitAudioContext)();

//     socket= new WebSocket("ws://localhost:3000");// Web scoket connection connect to server


//     socket.onopen= async ()=>{
//         statusDiv.textContent= "Connecting. Start speaking.."; // when connection successfully completed
...
//         // When came audio chunks 
//         mediaRecorder.ondataavailable=(event)=>{
//             if(event.data.size>0 && socket.readyState===WebSocket.OPEN){

//                 //this audio send to server
//                 socket.send(event.data)
//             }
//         }
//         mediaRecorder.start(250); //Every 250ms per send audio chunks
//     }
//          //when came to retrun audio mesaage from the server
//     socket.onmessage= async(event)=>{
//         const audioData = await event.data.arrayBuffer(); //push the audio data in queue
...
//             statusDiv.textContent= "Error connecting. Please try again";
//             stopConversation()
//         }
